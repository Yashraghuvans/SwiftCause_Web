...
import { Campaign, Kiosk, Permission } from '../../../shared/types';
...
import { Menu, X, Save, Upload, RefreshCw, AlertCircle } from 'lucide-react';
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-6xl p-0 border-0 shadow-2xl bg-white rounded-2xl overflow-hidden font-lexend h-[90vh] w-[95vw] sm:w-full flex flex-col [&>button]:hidden sm:[&>button]:flex">
        <VisuallyHidden>
          <DialogTitle>
            {editingCampaign ? 'Edit Campaign Configuration' : 'Campaign Setup Configuration'}
          </DialogTitle>
          <DialogDescription>
            {editingCampaign
              ? 'Modify the settings and configuration for this campaign'
              : 'Configure a new campaign with basic information, details, and media'}
          </DialogDescription>
        </VisuallyHidden>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <Label
                        ...
                        className="text-sm font-medium text-gray-500 uppercase tracking-wide mb-2 block"
                      >
                        CAMPAIGN TITLE
                      </Label>
                      <Input
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={(e) =>
                          setCampaignData((p) => ({ ...p, briefOverview: e.target.value }))
                        }
                ...
                <div className="max-w-4xl">
                  ...
                  <div className="space-y-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setCampaignData((p) => ({ ...p, category: e.target.value }))
                          }
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(value) =>
                            setCampaignData((p) => ({ ...p, status: value as Campaign['status'] }))
                          }
                        >
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-4">
                          {[
                            ...
                            <button
                              ...
                              type="button"
                              onClick={() => {
                                const isSelected = campaignData.recurringIntervals.includes(
                                  interval.value,
                                );
                                if (isSelected) {
                                  setCampaignData((p) => ({
                                    ...p,
                                    recurringIntervals: p.recurringIntervals.filter(
                                      (i) => i !== interval.value,
                                    ),
                                  }));
                                } else {
                    ...
                    <div className="col-span-full">
                      ...
                      />
                      {campaignData.tags &&
                        Array.isArray(campaignData.tags) &&
                        campaignData.tags.filter((tag) => tag.length > 0).length > 0 && (
                            ...
                            {campaignData.tags
                              ...
                              .map((tag, index) => (
                                <Badge
                                  key={index}
                                  variant="secondary"
                                  className="bg-green-50 text-green-700 border border-green-200 text-sm px-3 py-1.5 rounded-lg font-medium"
                                >
                                  {tag}
                                </Badge>
                              ))}
                      ...
                      <div className="flex items-center justify-between p-4 rounded-lg bg-blue-50 border border-blue-200">
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-600">
                            Enable Gift Aid declarations for UK taxpayers to increase donations by
                            25%
                          </p>
                        </div>
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            setCampaignData((p) => ({ ...p, giftAidEnabled: checked }))
                          }
                          className="ml-4"
                        />
                      </div>
                ...
                <div className="max-w-4xl">
                      ...
                      {campaignData.coverImageUrl || imagePreview ? (
                        ...
                        >
                          ...
                          <p className="text-gray-500 text-sm mb-2">
                            Click to upload from device or enter URL above
                          </p>
                  ...
                  <div className="mb-6 sm:mb-8">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setCampaignData((p) => ({ ...p, videoUrl: e.target.value }))
                        }
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                      ...
                      {campaignData.galleryImages &&
                        campaignData.galleryImages.length > 0 &&
                        campaignData.galleryImages.map((url, index) => (
                          <div
                            key={`existing-${index}`}
                            className="relative aspect-square border-2 border-gray-200 rounded-lg overflow-hidden bg-white"
                          >
                            <img
                              src={url}
                              alt={`Gallery ${index + 1}`}
                          ...
                          <Button
                            ...
                            onClick={() =>
                              handleRemoveGalleryImage(
                                (campaignData.galleryImages?.length || 0) + index,
                              )
                            }
                            variant="destructive"
                            size="sm"
                            ...
                            {loadingKiosks ? (
                              ...
                              <div className="space-y-2 max-h-64 overflow-y-auto">
                                {kiosks.map((kiosk) => {
                                  ...
                                  const isAssigned =
                                    campaignData.isGlobal ||
                                    (campaignData.assignedKiosks || []).includes(kiosk.id);
